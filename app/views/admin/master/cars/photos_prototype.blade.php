...
<div class='photos-carousel-prototype well'>
	<div class="container">
	    <div class="row">
			<div class="col-md-12">
	...
	{{ Form::model($car, ['route' => Helpers::createOrUpdateRoute($car),
             'class' => 'form-car hidden',
              ...
              {{ Form::hidden('id-prototype', null,
              	 array('class' => 'hidden prototype-input prototype-input-id', 'data-index' => 0,
              	 'data-relation' => 'photos', 'data-name' => 'id')) }}
              {{ Form::hidden('delete-prototype', null,
              	 array('class' => 'hidden prototype-input prototype-input-delete', 'data-index' => 0,
              	 'data-relation' => 'photos', 'data-name' => '_delete')) }}
